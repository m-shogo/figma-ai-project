...
// Figma/runtime comparison fallback only. Production destinations are not invented.
if (!$banner_items) {
    $banner_items = [
        [
            'title' => 'スポーツくじ',
...
$background_url = (string) apply_filters('nipponbudokan_top_banner_background_url', '');
