...
cd "$SCRIPT_DIR"
npx --yes --package=playwright@1.55.0 node text-runtime-check.mjs \
	"$URL" \
	"$OUTPUT_DIR/ref001-text-runtime.json"

printf 'REF-001 text runtime report written to %s/ref001-text-runtime.json\n' "$OUTPUT_DIR"
