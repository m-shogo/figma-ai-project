...
$steps = [
    ...
    ['03', '出会う', '先生と一緒に考える', ['教職員との距離が近い', '悩みを相談しやすい', '個人に合わせた進路のサポート'], 'education-3'],
    ['04', 'ゴール', '望んだ将来を実現させる', ['４年間の学びを進路につなげる', '経験を社会で発揮する', '自分らしい未来を見つける'], 'education-4'],
];
?>
