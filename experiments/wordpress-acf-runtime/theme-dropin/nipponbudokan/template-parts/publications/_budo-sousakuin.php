 ...
 * ダウンロード URL だけ最新号 ACF `sousakuin`。固定文は現行サイト / Figma 1767:9488。
 */
...
<div class="block-editor_wrap publication_budo-sousakuin">
    <details class="wp-block-details">
        ...
        <div class="publication_budo-sousakuinLead">
            <p class="has-small-font-size">下記よりダウンロードしてご利用ください。</p>
            <?php if (nbk_acf_value_present($file_url)) : ?>
                <div class="wp-block-buttons">
                    <div class="wp-block-button">
                        <a class="wp-block-button__link wp-element-button" href="<?php echo esc_url($file_url); ?>">月刊「武道」総索引ダウンロード</a>
                    </div>
                </div>
            <?php endif; ?>
        </div>
