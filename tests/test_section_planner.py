...
class SectionPlannerTests(unittest.TestCase):
    def test_independent_sections_share_one_wave(self) -> None:
        ...
        self.assertEqual(plan["waves"][0]["sections"], ["S01", "S02", "S03"])
    ...
    def test_dependencies_create_later_waves(self) -> None:
        ...
        self.assertEqual([wave["sections"] for wave in plan["waves"]], [["S01"], ["S02"], ["S03"]])

    def test_overlapping_write_scopes_become_sequential_waves(self) -> None:
        plan = build_plan(manifest([
    ...
    def test_complete_dependency_is_already_satisfied(self) -> None:
        ...
        self.assertEqual(plan["waves"][0]["sections"], ["S02"])
