<?php
/**
 * Template Name: LP-introduction ページ
 *
 ...
 *   <!-- ========== REASON ========== -->
 *
 * CSS は lp-introduction/css/ref001.css の同じ名前のブロックに入っています。
 ...
 *   lp-introduction/css/ref001.css              スタイル
 *   lp-introduction/js/ref001-interactions.js   アコーディオン / スライダー
 ...
 *   <?php include __DIR__ . '/lp-introduction/acf-swap/swiper-acf.php'; ?>
 * に差し替えてください。ACF が未設定でも同じ内容が表示されます。
 */

$lp_base = trailingslashit( get_stylesheet_directory_uri() ) . 'lp-introduction/';

wp_enqueue_style( 'ref001-lp-introduction-style', $lp_base . 'css/ref001.css', array(), null );
wp_enqueue_script( 'ref001-lp-introduction-script', $lp_base . 'js/ref001-interactions.js', array(), null, true );
?><!DOCTYPE html>
...
<section class="p-mv">
	...
	<a class="p-mv__oc" href="https://www.cku.ac.jp/admission/opencampus/" target="_blank" rel="noopener">
		<span class="p-mv__oc-balloon c-bubble"><span>大学の雰囲気を体験！</span></span>
...
<!-- ============================================================
     ...
     Swiper は lp-introduction/js/ref001-interactions.js が CDN から読み込んで
		...
		<ul class="p-courses__list">
			...
			<li class="p-courses__card" style="--course: #fabf12">
				...
				<div class="p-courses__rec">
					<p class="p-courses__rec-label c-bubble"><span>こんな人にオススメ！</span></p>
