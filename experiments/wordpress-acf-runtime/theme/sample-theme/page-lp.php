<?php
/**
 * Template Name: Sample Theme Fixture
 * Template Post Type: page
 */
declare(strict_types=1);

if (!function_exists('get_field')) {
    wp_die(esc_html__('ACF PRO is required for this runtime fixture.', 'sample-theme'), '', ['response' => 500]);
}
...
<body <?php body_class('sample-theme'); ?>>
<?php wp_body_open(); ?>
