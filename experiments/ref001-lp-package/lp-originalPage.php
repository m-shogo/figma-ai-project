...
<header class="ref-header" data-section="header" data-figma-pc="21378:8066" data-figma-sp="21376:4918">
...
<footer class="ref-footer" data-section="footer" data-figma-pc="21378:7457" data-figma-sp="21376:4402">
    <div class="ref-footer__inner">
        <div class="ref-footer__profile">
            <div class="ref-footer-logo">
                <img class="ref-footer-logo__image" src="<?php echo esc_url( $lp_base . 'image/icons/university-logo-outlined.svg' ); ?>" width="240" height="61" alt="千葉経済大学 CHIBA KEIZAI">
            </div>
        ...
        <button type="button" class="ref-footer__pagetop" aria-label="ページ上部へ">
            <img src="<?php echo esc_url( $lp_base . 'image/icons/footer-page-top.svg' ); ?>" alt="">
        </button>
    </div>
</footer>
<?php wp_footer(); ?>
